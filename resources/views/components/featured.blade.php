...
<div class="relative mt-10">
    ...
    <div class="relative  mx-auto px-6 sm:px-8 lg:px-12">
        <div class="text-center mb-12 animate-fade-in">
            <h2 class="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Featured Jobs</h2>
            <p class="text-gray-400 mt-2">Exclusive opportunities waiting for you</p>
        </div>
                    ...
                    <div class="group relative animate-slide-up" style="animation-delay: {{ $loop->index * 100 }}ms">
                        <div class="relative h-full bg-white/[0.05] backdrop-blur-xl rounded-xl border border-white/10 p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-white/5">
                            ...
                            <div class="flex justify-between items-start gap-4 mb-6">
                                ...
                                <span class="px-3 py-1 bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-white rounded-full text-sm font-medium animate-pulse-subtle border border-white/10">
                                    Featured
                                </span>
                            </div>
